...
class FormVR3(FlaskForm):
    ...
    prev_addr = StringField(gettext('3a_prev_addr'), validators=[RequiredIfBool('has_prev_addr', message=gettext('Required'))])
    prev_unit = StringField(gettext('3a_prev_unit'))
    prev_city = StringField(gettext('3a_prev_city'), validators=[RequiredIfBool('has_prev_addr', message=gettext('Required'))])
    prev_state = StringField(gettext('3a_prev_state'), validators=[RequiredIfBool('has_prev_addr', message=gettext('Required'))])
    prev_zip = StringField(gettext('3a_prev_zip'), validators=[Optional(), RequiredIfBool('has_prev_addr', message=gettext('Required')), Regexp('^\d{5}$', message=gettext('3_zip_help'))])
